...
public class UserDAO {
	...
	public boolean addUser(UserBean newUser) throws SQLException {
		...
		query = query + newUser.getUid() + ", " + newUser.getFname() + ", " + newUser.getLname() + ", " + newUser.getEmail() + ", " + newUser.getPassword() + ", " + newUser.getPrivilege() + "); " ; 
	...
	public Map<String,UserBean> getUserByZip(String zip) throws SQLException{
		...
		while (r.next()) {
			...
			UserBean user = new UserBean(r.getInt("uid"),r.getString("fname"), r.getString("lname"), r.getString("email"), 
